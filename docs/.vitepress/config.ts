      ...
      '/user-guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Scheduling Administration', link: '/user-guide/scheduling-administration' },
          ],
        },
      ],
      '/developer-guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Scheduling Ops', link: '/developer-guide/scheduling-ops' },
      ...
      '/api/': [
        {
          ...
          items: [
            ...
            { text: 'Tenant Scheduling Ops', link: '/api/tenant-v1-scheduling-ops' },
          ],
        },
      ],
      '/deployment/': [
