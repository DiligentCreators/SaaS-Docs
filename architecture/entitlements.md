...
How to **build** a licensed module end-to-end: [Module Development Standard](../modules/module-development.md). Platform freeze: [platform-freeze.md](platform-freeze.md).
